...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if(ouvriers.length < 10) {                                            // 
        ...
        var Nrecolteurs    = 3 ;                                           ///////////////////////////////////////////////////
        var Nupgraders     = 3 ;                                           //                                               //
        var Nconstruters   = 3 ;                                           //   Nombres des creeps par spécialités          //
        var Nreparaters    = 1 ;                                           //                                               //
                                                                           ///////////////////////////////////////////////////
        var moduleRecolteurs   = [WORK,WORK,CARRY,MOVE] ;           // 300 //                                               //
        var moduleUpgraders    = [WORK,CARRY,CARRY,CARRY,MOVE] ;    // 300 //   Les module des creeps par spécialités       //
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                                      //
//  An utilisant les informations de la partie 1 et de la partie 2, Nous pouvons commpleter la commanse ci-dessous pour créer le creep  //
//                                                                                                                                      //
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if(Memory.rcl == 1) {
        ...
        console.log('Route en haut à gauche est positionner' )
        ...
        console.log('Route en bas à droit est positionner' )
        var Xspawn = XspawnSave
        var Yspawn = YspawnSave
        ...
        console.log('Route en haut à droit est positionner')
        var Xspawn = XspawnSave
        var Yspawn = YspawnSave
        ...
        console.log('Route en bas à gauche est positionner ')
        var Xspawn = XspawnSave
        var Yspawn = YspawnSave
        ...
        console.log('Route à droit est positionner ')
        var Xspawn = XspawnSave
        ...
        console.log('Route à gauche est positionner ')
        var Xspawn = XspawnSave
        ...
        console.log ('Route en bat est positionner')
        var Yspawn = YspawnSave
        ...
        console.log ('Route en haut est positionner')
        Memory.rcl = 0
